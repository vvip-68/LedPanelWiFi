...
void parsing() {  
  /*
    ...
    12 - Настройки погоды
      ...
      - $12 7 X;   - отображение температуры в малых часах: X - битовая карта, b0 - отображать  C/F, b1 = отображать значок градуса
...
String getStateValue(const String& key, int8_t effect, bool shrt) {
  ...
  // WV:X        Как показывать температуры в малых часах (битовая карта) b0 - показывать C/F, b1 - показывать знак градуса
  ...
  // Отображать в температуре малым шрифтом значок градуса и букву C/F
  if (key == "WV") {
