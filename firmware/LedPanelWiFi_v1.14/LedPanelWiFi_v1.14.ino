...
// При подключении того же самого микроконтроллера к более свежей матрице 2022-2024 годов - никаких проблем нет, все корректно отображается
//
...
// Версия ядра ESP32   - 2.0.14 // На версиях 2.x.x (кроме 2.0.14) скетчи может не собираться совсем или собирается но работать некорректно
//
// -------------------------------------------------------------------------------------------------------
//
...
// C последней на текущий момент версией 3.9.0 компиляция не проходит - сыплются ошибки, там что-то серьезно изменилось
// и эти версии библиотек не совместимы с проектом. 
