...
//
// Версия ядра ESP8266 - 3.1.2 (или 2.7.4, но в 2.7.4 назначенные вывод LED_PIN 2 (D4) ядро переназначает на D2 - примите к сведению)
// Версия ядра ESP32   - 2.0.6 (или 2.0.9; версии 2.0.7 и 2.0.8 не тестировались, но, думаю, должны работать)
// Версия FastLED      - 3.5.0 (или 3.4.0)
//
// -------------------------------------------------------------------------------------------------------
//
// Для ядра ESP8266 v2.7.4 
...
//   здесь же в пункте "Arduino Runs On" выбрать "Core 0". По умолчанию тут выбрано "Core 1", но при такой настройке
//   могут наблюдаться подергивания при прокрутке бегущей строки
//
// -------------------------------------------------------------------------------------------------------
//
// *** MP3 DFPlayer
