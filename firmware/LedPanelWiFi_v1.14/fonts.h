...
//{0x3e, 0x51, 0x49, 0x45, 0x3e}, // 0 0x30 48  16 - 0 перечеркнутый
  {0x3e, 0x41, 0x41, 0x41, 0x3e}, // 0 0x30 48  16 - 0 круглый
...
//{0x20, 0x40, 0x44, 0x3d, 0x00}, // j 0x6a 106  74
 ...
 //0x0c, 0x50, 0x50, 0x50, 0x3c}, // y 0x79 121  89
  {0x1C, 0xA0, 0xA0, 0xA0, 0x7C}, // y 0x79 121  89
...
//{0x0C, 0x50, 0x50, 0x50, 0x3C}, //у      146
  {0x1C, 0xA0, 0xA0, 0xA0, 0x7C}, //у      146
  ...
  {0x00, 0x40, 0x7C, 0x45, 0x00}, // í     164
  {0x3E, 0x55, 0x55, 0x41, 0x22}, // €     165
  {0x00, 0x00, 0x7B, 0x00, 0x00}, // ¡     166
  {0x30, 0x48, 0x45, 0x40, 0x20}, // ¿     167
  {0x00, 0x7F, 0x40, 0x40, 0x40}  // Ł     168
...
const uint8_t diasHEX[][5] PROGMEM = {
  ...
  {0x00, 0x00, 0x02, 0x01, 0x00}, // Á - знак ударения Á, É, Í, Ó, Ú, á, é, í, ó, ú
  {0x00, 0x02, 0x01, 0x02, 0x01}, // Ñ - тильда Ñ,ñ
  {0x00, 0x80, 0x40, 0x00, 0x00}, // Ņ - запятая Ģ, Ķ, Ļ, Ņ
  {0x00, 0x10, 0x08, 0x04, 0x00}, // ł - перечеркивание ł (по центру)
  {0x10, 0x08, 0x04, 0x00, 0x00}  // Ł - перечеркивание Ł (смещение влево)
};
...
const uint16_t diasHEX[][10] PROGMEM = {
  ...
  {0x0000, 0x0000, 0x0000, 0x0000, 0x0002, 0x0003, 0x0001, 0x0000, 0x0000, 0x0000}, // Á - знак ударения Á, É, Í, Ó, Ú, á, é, í, ó, ú
  {0x0000, 0x0000, 0x0002, 0x0001, 0x0001, 0x0002, 0x0002, 0x0001, 0x0000, 0x0000}, // Ñ - тильда Ñ,ñ
  {0x0000, 0x0000, 0x0000, 0x8000, 0xC000, 0x4000, 0x0000, 0x0000, 0x0000, 0x0000}, // Ņ - запятая Ģ, Ķ, Ļ, Ņ
  {0x0000, 0x0000, 0x0300, 0x0180, 0x01C0, 0x00E0, 0x0060, 0x0030, 0x0000, 0x0000}, // ł - перечеркивание ł (по центру)
  {0x0300, 0x0180, 0x01C0, 0x00E0, 0x0060, 0x0030, 0x0000, 0x0000, 0x0000, 0x0000}  // Ł - перечеркивание Ł (смещение влево)
};
...
const uint16_t diasHEX[][8] PROGMEM = {
  ...
  {0x0000, 0x0000, 0x0000, 0x0002, 0x0003, 0x0001, 0x0000, 0x0000}, // Á - знак ударения Á, É, Í, Ó, Ú, á, é, í, ó, ú
  {0x0000, 0x0000, 0x0002, 0x0001, 0x0002, 0x0001, 0x0000, 0x0000}, // Ñ - тильда Ñ,ñ
  {0x0000, 0x0000, 0x1000, 0x1800, 0x0800, 0x0000, 0x0000, 0x0000}, // Ņ - запятая Ģ, Ķ, Ļ, Ņ
  {0x0000, 0x0080, 0x00C0, 0x00E0, 0x0070, 0x0030, 0x0010, 0x0000}, // Ł - перечеркивание ł (по центру)
  {0x0180, 0x00C0, 0x00E0, 0x0070, 0x0030, 0x0018, 0x0000, 0x0000}  // Ł - перечеркивание Ł (смещение влево)
};
