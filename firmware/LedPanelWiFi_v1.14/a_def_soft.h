...
#define  QSIZE_OUT 48                       // размер очереди исходящих сообщений Web
#define  QSIZE_IN 16                        // размер очереди входящих команд от Web
...
//#define    BUF_CMD_SIZE  512                // максимальный размер выделяемого буфера для входящих сообщений по Web каналу
//char       incomeCmdBuffer[BUF_CMD_SIZE];   // Буфер для приема строки команды из Web
