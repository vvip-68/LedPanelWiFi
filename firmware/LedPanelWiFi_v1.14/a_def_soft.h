...
static const char SD_TEXT_STORAGE[] PROGMEM = "/txt";            // Все строки хранятся в файловой системе микроконтроллера в папке '/txt'
static const char BK_TEXT_STORAGE[] PROGMEM = "/txt.bkp";        // Резервные копии строк хранятся в папке '/txt.bkp'
