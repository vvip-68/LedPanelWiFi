...
typedef struct  {                           // Структура описателя событий постоянного контроля
  ...
  bool   flagT;                             // Для макроса {P} - наличие влага #T, указывающий вывод обратного отсчета по центру
} Moment;
...
// *****************************************************************************
  ...
  uint8_t vPOWER_ON;           // Уровень сигнала на реле для включения HIGH (0x01) или LOW (0x00)
