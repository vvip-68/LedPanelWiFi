...
#define LED_PIN  D2             // D2 физческий пин ленты lk ядра 3.1.2; для ядра 2.7.4 и выбранной платы NodeMCU v1.0 (ESP12-E) укажите здесь 2 (это GPIO2 или D4) - вывод все равно будет переназначен ядром на D2
...
#define LED_PIN D2              // D2 физческий пин ленты для ядра 3.1.2; для ядра 2.7.4 и выбранной платы NodeMCU v1.0 (ESP12-E) укажите здесь 2 (это GPIO2 или D4) - вывод все равно будет переназначен ядром на D2
