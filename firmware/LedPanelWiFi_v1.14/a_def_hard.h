...
#define LED_CHIP       WS2812B  // CHIP ленты для библиотеки FASTLED - WS2811, WS2812, WS2812B, WS2813, APA102, APA104, SK6812, SK6822 и друние - см. документацию на FastLED
...
#define LED_PIN  D2             // D2 физческий пин ленты: для ядра 2.7.4 и выбранной платы NodeMCU v1.0 (ESP12-E) укажите здесь 2 (это GPIO2 или D4) - вывод все равно будет переназначен ядром на D2
...
#define SD_CS_PIN D8            // пин выбора SD карты - ChipSelect; Также SD карта использует D5 (CLK), D6 (MISO), D7 (MOSI) - совместная работа с TM1637 невозможна, т.к. используют те же пины - либо то, либо то
