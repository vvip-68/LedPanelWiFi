...
Список ключей и формат возвращаемых значений приведены в таблице  
  ...
  | **C35**  |**C35:X**          | Тип шрифта 3x5 в часах - 0 - строгий, 1 - скругленный 
  ...
  | **WV**   |**WV:X**           | показ погоды, битовая карта X - битовая карта, b0 - отображать  C/F, b1 = отображать значок градуса 
