...
![Среда разработки Arduino IDE](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_01.png)
...
![Среда разработки Arduino IDE](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_01_0.png)

Можете заплатить донат разработчикам Ardoino IDE. Но если не хотите - просто нажмите кнопку **JUST DOWNLOAD**
для загрузки установочного файла. После завершения скачивания запустите его.

![Среда разработки Arduino IDE](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_01_1.png)
...
![Настройки среды разработки ArduinoIDE](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_02_1.png)

В открывшемся окне нажмите на кнопку справа от поля "Дополнительные ссылки для менеджера плат"

![Дополнительные ссылки для менеджера плат](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_02_2.png)
...
![Ссылка на плату ESP8266](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_02_3.png)
...
![Менеджер плат](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_03_1.png)

В строке фильтра введите "ESP8266", найдите блок esp8266 by ESP8266 Commumity  
1. Выберите версию ядра 2.7.4
2. Нажмите кнопку "Устанока", дождитесь завершения установки.
3. Должна появиться надпись, подтверждающая что вы установили правильную (2.7.4!!!) версию ядра системы

![Менеджер плат - установка](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_03_2.png)
...
![Менеджер плат - установка](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_03_3.png)
...
![Загрузка проекта из репозитория](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_04_1.png)
...
![Копирование библиотек](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_05_1.png)
...
![Менеджер библиотек](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_06_1.png)
...
![Менеджер библиотек](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_06_2.png)
...
![Проводник - папка проекта](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_07_1.png)
...
![Редактор кода](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_07_2.png)
...
![Параметры сборки](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_07_3.png)
...
![Управление компьютером](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_07_4.png)

<a id="com-port"></a>
Найдите COM-порт, соответствующей вашей подключенной плате.

![Менеджер устройств](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_07_5.png)
...
![Проверка скетча](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_08_1.png)
...
![Загрузка скетча](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_09_1.png)

Нажмите на кнопку "Загрузка" для загрузки скетча в микроконтроллер. Дождитесь завершения операции загрузки. 

![Загрузка скетча](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_09_2.png)
...
![Загрузка скетча](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Step_09_3.png)

Для завершения процесса сборки устройства подключитесь к созданной устройством точке доступа PanelAP и откройте в браузере страничку настроек по адресу 192.168.4.1  
[Выполните настройку](https://github.com/vvip-68/LedPanelWiFi/wiki/Настройка-параметров-в-приложении)
