...
![Тип матрицы](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Matrix/scheme1.jpg)
...
![Тип матрицы](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Matrix/scheme3.jpg)
...
![Тип подключения](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Matrix/scheme2.jpg)
...
![Сборная матрица №1](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Matrix/scheme4.jpg)
...
**Тип расположения** сегментов в сборной матрице - змейкой или параллельно задается параметром **META_MATRIX_TYPE**:  
...
![Пример 1](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Matrix/Example1.jpg)

## Сборная матрица 3x2 из шести сегментов 8x8 - вариант 2

![Сборная матрица №1](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Matrix/scheme5.jpg)

Сборная матрица, приведенная на рисунке выше описывается следующей комбинацией параметров:  

![Пример 2](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Matrix/Example2.jpg)
...
![Пример 3](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Matrix/Example3.jpg)
...
![Panel Setup](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/Matrix/MatrixSetup.png)

Выберите вариант настройки **"Использовать сегменты"**.
Ниже вы увидите два раздела - ***Сегмент матрицы*** и ***Сборноая матрица***.

## Сегмент матрицы

Укажите размеры одного сегмента матрицы - **ширину** и **высоту**, выберите тип подключения цепочки светодиодов - **"Зигзаг"** (*последовательное соединение*)
или **"Параллельное"**, нажимая на стрелочке в центре схематического изображения матрицы. 
Отметьте чекбокс расположения **угла матрицы** (где находится первый светодиод в цепочке) и **направление** следования цепочки светодиодов из этого угла.  

## Сборная матрица

Укажите количество сегментов сборной матрицы в **ширину** и **высоту**. Выберите тип последовательности соединения сегментов - **зигзагом** или **параллельно**.
...
Нажмите кнопку **"Применить"** для сохранения выполненных настроек. После завершения конфигурирования матрицы контроллер автоматически перезагрузится и новые параметры вступят в силу.   
