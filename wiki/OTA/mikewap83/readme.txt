...
!!! Важный момент. В Arduino IDE 2.x в меню "Инструменты" не появится новый вариант PartitionScheme, пока мы не удалим скешированную папку приложения,
для этого необходимо удалить папку C:\Users\[ИМЯ пользователя]\AppData\Roaming\arduino-ide\
