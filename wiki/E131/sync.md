...
Настройка внешнего источника синхронизации на примере программы управления световым оборудованием ***"Jinx!"*** описана в этой [статье](https://github.com/vvip-68/LedPanelWiFi/wiki/Настройка-ПО-управления-эффектами-%22Jinx!%22-как-источника-синхронизации-устройств-в-группе).
