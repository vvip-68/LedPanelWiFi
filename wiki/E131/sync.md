...
- [Настройка  ***"Jinx!"*** как источника эффектов](https://github.com/vvip-68/LedPanelWiFi/wiki/Настройка-ПО-управления-эффектами-Jinx!-как-источника-синхронизации-устройств-в-группе).  
...
![Сеть](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/E131/Network.jpg)
...
Кроме полноэкранной синхронизации ***логический уровень*** позволяет создавать [распределенные](https://github.com/vvip-68/LedPanelWiFi/wiki/Распределенная-матрица) матрицы - когда источник - мастер формирует полный виртуальный кадр изображения, физически выводя на матрицу лишь часть изображения кадра, остальные части виртуального кадра отправляются ***отдельным приемникам***, каждый из которых может выводить свою часть из полного кадра.  
...
![Сравнение](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/E131/Texts.png)
...
![Сеть](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/E131/Network-Jinx!.jpg)

Настройка внешнего источника синхронизации на примере программы управления световым оборудованием ***"Jinx!"*** описана в этой [статье](https://github.com/vvip-68/LedPanelWiFi/wiki/Настройка-ПО-управления-эффектами-Jinx!-как-источника-синхронизации-устройств-в-группе).

## Настройка синхронизации

Задание роли для конкретного устройства производится в Web-приложении в разделе **"Настройка"**, **"Группы"**. 
Откройте Web-интерфейс устройства в браузере и перейдите к настройкам.

![Настройка](https://github.com/vvip-68/LedPanelWiFi/blob/main/wiki/E131/setup-group.png) 
