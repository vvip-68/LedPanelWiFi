...
несколько отдельных сегментов, каждый из которых работает под упправлением собственного микроконтроллера в один большой виртуальный экран.  
...
Отсчет пикселей в гирлянде - левый верхний угол, координаты угла - **X=0**, **Y=0**. Все устройства принадлежат одной группе синъронизации.  
...
Обозначим, для примера устройства:  
 ...
 | **Приемник 2** | ***ESP8266***   | *192.168.0.101* | Сегмент 3 | 0,16      | 16x16  
 | **Приемник 3** | ***ESP8266***   | *192.168.0.101* | Сегмент 4 | 16,16     | 16x16  
...
Для применения настроек приемника - нажмите кнопку **"Применить"**. Настройки должн scnegbnm в силу немедленно, вывод полного кадра - посегментно на каждом устройстве в соответствии с привязкой.