...
Также - если вы управляли своей гирляндой удаленно через MQTT с андроид приложения из проекта - вам лучше оставаться не предыдущей версии - этав версия
...
брокером на уровне, описывающем какие команды отправлять, какие слушать, форимат команд, как поддержать интеграцию с умным домом, тогда управление через MQTT 
и вернется в прошивку. Пока - нет.

Основное назначение проекта - настенные экраны или гирлянды на широкие балконы.
...
- ***Новое!!!*** - Управление дополнительными силовыми механизмами через реле по сигналам:   
