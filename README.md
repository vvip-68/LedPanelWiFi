...
### Фишки
 ...
 - Поддержка символов украинского, литовского и некоторых других языков, использующих диакритические символы, в т.ч буква Ё (в этом случае - размер шрифта 5x11, 8x17, 10x20 точек)
 ...
 - ***Новое!!"*** - Поддержка [распределённых матриц](https://github.com/vvip-68/LedPanelWiFi/wiki/Распределенная-матрица) - разнесенных в пространстве матриц (например гирлянда на три окна), работающая как единая матрица, хотя каждый разнесенный сегмент управляется собственным микроконтроллером. 
