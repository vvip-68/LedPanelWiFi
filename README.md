...
- Отображение IP адреса панели на матрице и на индикаторе TM1637, если подключение к локальной WiFi сети установлено
...
- Отображение Версии микропрограммы панели на матрице
